...
pretrained_lora_path = "./gemma-finetuned-4th"  # 前回学習したLoRAアダプタのパス
...
# --- 3. 新しいデータセットのロード ---
new_train_data_path = "./4th_recipe_data_train.jsonl"
new_validation_data_path = "./4th_recipe_data_validation.jsonl"
...
training_args = TrainingArguments(
    output_dir="./gemma-finetuned-4th-continued",
    ...
    fp16=False,
    bf16=True,
    logging_dir='./logs_4th_continued',
    logging_steps=10,
...
# --- 8. モデルの保存 ---
trainer.save_model("./gemma-finetuned-4th-continued")
