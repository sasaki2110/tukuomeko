...
# 1. モデルとトークナイザーのロード
# Gemma 2B Instruction-tuned モデルID
...
dataset = load_dataset(
    "json",
    data_files={
        "train": "/app/data/recipe_data_train.jsonl",
        "validation": "/app/data/recipe_data_validation.jsonl"
    }
)
...
training_args = TrainingArguments(
    output_dir="./gemma-finetuned", # 学習済みモデルの保存先ディレクトリ
